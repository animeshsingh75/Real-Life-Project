...
onload = function() {
    ...
    add.onclick = function() {
        ...
        if (details[1].length !== 6) {
            alert("Incorrectly formatted input.Enter a 6 digit number");
            return;
        }
        contact_list.add(details[1], details[0]);
        info.innerHTML += details[0] + " ," + details[1] + " added to contact list<br>";
        contact_info.value = "";
    };
    del.onclick = function() {
        ...
        info.innerHTML += details + " from contact list<br>";
        delete_info.value = "";
    }
